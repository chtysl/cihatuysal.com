<div class="hero min-h-screen bg-base-200">
	<div class="hero-content mx-8 flex-col lg:flex-row-reverse">
		<img src="/cihatuysal.jpeg" class="max-w-sm rounded-lg shadow-2xl" />
		<div>
			...
			<p class="py-6">
				...
				pekiştirmiş oluyorum. Aynı zamanda doğup büyüdüğüm Doyran ve çevresinde uzmanlık
